...
export default class PgColorAndHtml extends PgColorAndHtmlDesign {
    ...
    initGetCombinedStyle() {
        const { backgroundColor } = getCombinedStyle('.getCombinedStyleTest');
