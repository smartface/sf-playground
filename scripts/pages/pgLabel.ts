...
export default class PgLabel extends withDismissAndBackButton(PgLabelDesign) {
  ...
  onLoad() {
    ...
    this.addChild(this.myFlexLayout, 'myFlexLayout', '.sf-flexLayout', flexLayoutOptions);
    ...
    this.addChild(this.myFlexLayout1, 'myFlexLayout1', '.sf-flexLayout', flexLayoutOptions);
    ...
    this.addChild(this.myFlexLayout2, 'myFlexLayout2', '.sf-flexLayout', flexLayoutOptions);
