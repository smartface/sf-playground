...
export default class PgArt extends PgArtDesign {
  ...
  constructor() {
    ...
    this.emojis = [
      `data:image/png;base64,${TEST_EMOJI_BASE64}`,
      `data:image/png;base64,${this.getBase64OfSmartfacemage()}`,
      `data:image/png;base64,eymBASDASd`,
    ];
  }
...
function onShow(this: PgArt, superOnShow: () => void) {
  superOnShow();
}

function onLoad(this: PgArt, superOnLoad: () => void) {
  superOnLoad();
  this.initSwitch();
